    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('DEV', 'Developer')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cv', models.FileField(blank=True, upload_to='docs/cvs')),
                ('address', models.CharField(blank=True, max_length=100)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='skills',
            field=models.ManyToManyField(related_name='tags', to='login.Skill'),
        ),
        migrations.AddField(
            model_name='jobseekerprofile',
            name='user',
